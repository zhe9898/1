...
from backend.runtime.execution.job_type_separation import SCHEDULED_JOB_SOURCES, get_job_type, get_max_concurrent_limit
...
def export_job_concurrency_contract() -> dict[str, object]:
    return {
        "service": "backend.runtime.execution.job_concurrency_service.JobConcurrencyLeaseWindow",
        "entrypoints": [
            "assert_capacity",
