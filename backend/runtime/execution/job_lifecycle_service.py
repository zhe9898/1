...
from backend.runtime.execution.failure_taxonomy import FailureCategory
from backend.runtime.execution.job_status import canonicalize_job_attempt_status_input, canonicalize_job_status_input
...
class JobLifecycleService:
    ...
    async def expire_lease(
        ...
        *,
        ...
        job.failure_category = FailureCategory.LEASE_EXPIRED.value
        job.started_at = None
        job.completed_at = None
        job.updated_at = now
        await db.flush()
