...
class GovernanceFacade:
    ...
    async def set_feature_guarded(
        ...
        from backend.runtime.scheduling.scheduling_governance import set_scheduling_feature
    ...
    def configure_zone_context(self, zone_load: dict[str, int]) -> None:
        from backend.runtime.scheduling.scheduling_resilience import TopologySpreadPolicy
    ...
    async def is_feature_enabled(self, db: AsyncSession, flag_key: str) -> bool:
        from backend.runtime.scheduling.scheduling_governance import is_scheduling_feature_enabled
    ...
    def run_placement_solver(
        ...
        *,
        ...
        from backend.runtime.scheduling.job_scheduler import get_placement_solver
    ...
    def get_dispatch_pipeline(self) -> object:
        from backend.runtime.execution.dispatch_lifecycle import get_dispatch_pipeline
