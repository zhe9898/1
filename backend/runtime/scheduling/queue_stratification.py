...
# ============================================================================
# Configuration 鈥?read from system.yaml with hardcoded fallbacks
# ============================================================================
...
def _load_scheduling_config() -> dict:
    ...
    Returns a stable dict contract for callers that consume scheduling defaults.
    """
...
# Module-level default snapshots kept for direct readers of scheduling defaults.
# New code should prefer the functions above.
_QC_DEFAULTS = QueueConfig()
...
class TenantQuota:
    ...
    Attributes:
        ...
        weight: Fair-share weight 鈥?higher weight = proportionally more quota
...
# Backward-compatible alias 鈥?new code should call _get_service_class_config()
...
class GlobalFairScheduler:
    ...
    def apply_fair_share(
        ...
        2. Build a weighted round-robin schedule 鈥?higher weight tenants
