...
def _serialize_dimension_delta(delta: object) -> dict[str, object]:
    from backend.runtime.scheduling.scheduler_auto_tune_state import DimensionStateDelta
...
def _serialize_tracker_delta(delta: object) -> dict[str, object]:
    from backend.runtime.scheduling.scheduler_auto_tune_state import TrackerStateDelta
