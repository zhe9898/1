...
from backend.runtime.scheduling.job_scheduler import SchedulerNodeSnapshot, node_blockers_for_job

if TYPE_CHECKING:
    from backend.models.job import Job
    from backend.runtime.scheduling.backfill_scheduling import ReservationManager
