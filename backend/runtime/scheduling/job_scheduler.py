...
from backend.runtime.scheduling.job_scoring import (  # noqa: F401 閳?re-export
    _stable_tiebreak,
    score_job_for_node,
)
from backend.runtime.scheduling.placement_solver import (  # noqa: F401 閳?re-export
    PlacementCandidate,
    PlacementSolver,
    _get_solver_config,
...
from backend.runtime.scheduling.scheduling_candidates import (  # noqa: F401 閳?re-export
    _bool_attr,
...
from backend.runtime.scheduling.worker_pool import infer_node_worker_pools, resolve_job_queue_contract_from_record
from backend.runtime.topology.runtime_contracts import node_executor_contract, node_supported_workload_kinds
...
def node_blockers_for_job(  # noqa: C901
    ...
    *,
    ...
    from backend.runtime.scheduling.scheduling_strategies import check_node_affinity
...
def select_jobs_for_node(  # noqa: C901
    ...
    *,
    ...
    from backend.runtime.scheduling.backfill_scheduling import BackfillEvaluator, get_reservation_manager
    ...
    # 鈹€鈹€ Phase B: Batch eligible counts for pre-filtered jobs only 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
    ...
    # 閳光偓閳光偓 Phase C: Score + top-K pruning 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
    ...
    for job in compatible:
        ...
        # 閳光偓閳光偓 Placement policy accept gate 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
    ...
    # 閳光偓閳光偓 Placement policy rerank pass 閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓閳光偓
    from backend.runtime.scheduling.placement_policy import get_placement_policy as _get_pp
