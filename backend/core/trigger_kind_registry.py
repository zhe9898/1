...
class WebhookTriggerConfig(BaseModel):
    ...
    signature_header: str = Field(
        default="X-ZEN70-Webhook-Signature",
        min_length=1,
        max_length=128,
        validation_alias=AliasChoices("signature_header", "secret_header"),
    )
    timestamp_header: str = Field(default="X-ZEN70-Webhook-Timestamp", min_length=1, max_length=128)
    max_signature_age_seconds: int = Field(default=300, ge=30, le=86400)
