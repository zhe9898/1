...
from backend.extensions.extension_sdk import bootstrap_extension_runtime, get_published_job_kind, get_published_workflow_template
    ...
    *,
    ...
    try:
        ...
        await publish_control_event(
            ...
            "delivery_failed",
            _delivery_event_payload(trigger, delivery),
            tenant_id=trigger.tenant_id,
        )
        raise
