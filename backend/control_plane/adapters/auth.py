...
from backend.control_plane.adapters import auth_bootstrap, auth_invite, auth_password, auth_pin, auth_user, auth_webauthn
from backend.control_plane.adapters import push as push_router
...
# Re-export endpoint functions for tests that import from backend.control_plane.adapters.auth directly
...
# Re-export helpers so tests can patch on backend.control_plane.adapters.auth namespace
