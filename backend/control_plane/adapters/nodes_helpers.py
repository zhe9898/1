"""
ZEN70 Nodes API 閳?Helper functions.
...
from backend.control_plane.adapters.action_contracts import ControlAction, optional_reason_field
...
from backend.runtime.scheduling.worker_pool import infer_node_worker_pools
from backend.runtime.topology.node_auth import generate_node_token, hash_node_token
from backend.runtime.topology.runtime_contracts import (
...
def _apply_contract(node: Node, payload: NodeContractPayload, status: str, now: datetime.datetime) -> None:
    ...
    if not explicit_profile:
        from backend.runtime.topology.device_profiles import apply_profile_defaults, get_device_profile, infer_device_profile
        ...
        from backend.runtime.topology.device_profiles import apply_profile_defaults, get_device_profile
