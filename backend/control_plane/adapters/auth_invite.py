...
from backend.control_plane.adapters.auth_shared import assert_user_active, register_login_session
from backend.control_plane.adapters.auth_token_issue import issue_auth_token
from backend.control_plane.adapters.deps import get_current_admin, get_db, get_redis
...
async def create_invite(
    ...
    from backend.control_plane.adapters.auth_shared import bind_admin_scope
