...
from backend.control_plane.adapters.deps import get_current_admin, get_machine_tenant_db, get_node_machine_token, get_redis, get_tenant_db
...
async def fair_share_config(
    ...
    del current_user
    from backend.runtime.scheduling.queue_stratification import SERVICE_CLASS_CONFIG, get_fair_scheduler
