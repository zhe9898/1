...
from backend.extensions.job_kind_registry import assert_job_submission_authorized, validate_job_payload
...
from backend.runtime.scheduling.worker_pool import resolve_job_queue_contract
from backend.runtime.topology.runtime_contracts import UNKNOWN_PERSONA, is_control_plane_persona
...
async def _check_submission_admission(db: AsyncSession, tenant_id: str) -> None:
    from backend.runtime.scheduling.scheduling_resilience import AdmissionController, SchedulingMetrics
...
async def _lock_and_guard_submission_capacity(
    ...
    *,
    ...
    from backend.runtime.execution.job_type_separation import apply_job_type_defaults, get_job_type
