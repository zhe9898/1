...
from backend.kernel.scheduling.job_scoring import (  # noqa: F401 閳?re-export
    _stable_tiebreak,
    score_job_for_node,
)
from backend.kernel.scheduling.placement_solver import (  # noqa: F401 閳?re-export
    PlacementCandidate,
    PlacementSolver,
    _get_solver_config,
...
from backend.kernel.scheduling.scheduling_candidates import (  # noqa: F401 閳?re-export
    _bool_attr,
...
def node_blockers_for_job(  # noqa: C901
    ...
    *,
    ...
    from backend.kernel.scheduling.scheduling_strategies import check_node_affinity
...
def select_jobs_for_node(  # noqa: C901
    ...
    *,
    ...
    from backend.kernel.scheduling.placement_policy import get_placement_policy as _get_pp
