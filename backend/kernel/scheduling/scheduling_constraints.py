...
class DependencyGate(SchedulingConstraint):
    ...
    def evaluate(self, job: Job, ctx: SchedulingContext) -> tuple[bool, str]:
        from backend.kernel.scheduling.business_scheduling import check_job_dependencies_satisfied
...
class GangSchedulingGate(SchedulingConstraint):
    ...
    def evaluate(self, job: Job, ctx: SchedulingContext) -> tuple[bool, str]:
        from backend.kernel.scheduling.gang_scheduler import calculate_gang_scheduling_readiness
...
class PriorityBoostModifier(SchedulingConstraint):
    ...
    def evaluate(self, job: Job, ctx: SchedulingContext) -> tuple[bool, str]:
        from backend.kernel.scheduling.business_scheduling import calculate_boosted_priority
