...
from backend.control_plane.admin.audit_logging import write_audit_log
from backend.kernel.scheduling.scheduler_auto_tune_state import AutoTuneAuditRecord
...
def _serialize_dimension_delta(delta: object) -> dict[str, object]:
    from backend.kernel.scheduling.scheduler_auto_tune_state import DimensionStateDelta
...
def _serialize_tracker_delta(delta: object) -> dict[str, object]:
    from backend.kernel.scheduling.scheduler_auto_tune_state import TrackerStateDelta
