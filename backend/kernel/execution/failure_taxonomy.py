...
def calculate_retry_delay_seconds(
    ...
    *,
    ...
    Transient / timeout 鈫?gentle backoff (base * 2^n, cap max)
    Resource / node_unhealthy 鈫?heavier backoff (base*multiplier * 2^n, cap max)
    Lease_expired / node_drained 鈫?short fixed delays
    """
