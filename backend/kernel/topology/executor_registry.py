"""Executor Contract Registry 鈥?formal capability declarations.
...
1. **Node registration** 鈥?validate executor field against known contracts.
2. **Dispatch scoring**  鈥?bonus for exact executor match, penalty if
   contract declares the job kind unsupported.
3. **Console / diagnostics** 鈥?surface executor capability matrix.
...
# 鈹€鈹€ Default contracts (always available) 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
class ExecutorRegistry:
    ...
    def validate_node_executor(
        ...
        *,
        ...
        if contract is None:
            return [f"executor '{executor}' not in registry 鈥?permissive fallback"]
    ...
    def is_kind_supported(self, executor: str, kind: str) -> bool | None:
        ...
        contract = self.get(executor)
        if contract is None:
            return None  # unknown executor 鈫?permissive
